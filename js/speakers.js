                    ...
                    <div class="ribbon" id="category-${category}" 
                        ...
                        <div class="card">
                            ...
                            <section class="profcard" id="${speaker.ID}" onclick="openSpeakerProfile('${speaker.ID}')">
                                <div class="bands">
                                    <img src="${speaker.FullPath || 'default-image.png'}" onerror="this.onerror=null; this.src='GSAC26/images/photo.jpg'">
...
window.openSpeakerProfile = function(speakerID) {
    ...
    modalBody.innerHTML = `
        <div class="band">
            <img src="${speaker.querySelector('img').src || 'default-image.png'}" onerror="this.onerror=null; this.src='GSAC26/images/photo.jpg'">
            <div class="band2">
